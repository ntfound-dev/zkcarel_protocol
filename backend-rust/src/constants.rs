...
pub const POINTS_MIN_USD_LIMIT_ORDER_TESTNET: f64 = 0.01;
...
pub const POINTS_MIN_USD_BRIDGE_ETH_TESTNET: f64 = 1.0;
pub const POINTS_MIN_USD_BRIDGE_BTC_TESTNET: f64 = 10.0;
pub const POINTS_PER_USD_STAKE: f64 = 3.0;
pub const POINTS_MIN_STAKE_CAREL: f64 = 100.0;
pub const POINTS_MIN_STAKE_STRK: f64 = 200.0;
pub const POINTS_MIN_STAKE_STABLECOIN: f64 = 10.0;
pub const POINTS_MIN_STAKE_BTC: f64 = 0.0005;
pub const POINTS_MIN_STAKE_LP: f64 = 1.0;
pub const POINTS_MIN_STAKE_CAREL_TESTNET: f64 = 1.0;
pub const POINTS_MIN_STAKE_STRK_TESTNET: f64 = 200.0;
pub const POINTS_MIN_STAKE_STABLECOIN_TESTNET: f64 = 10.0;
pub const POINTS_MIN_STAKE_BTC_TESTNET: f64 = 0.0005;
pub const POINTS_MIN_STAKE_LP_TESTNET: f64 = 0.01;
