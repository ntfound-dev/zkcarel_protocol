...
fn test_rate_limit_enforcement() {
    ...
    let mut i: u64 = 0;
    while i < 10 {
        dispatcher.submit_action(ActionType::Stake, "stake action", 0, 0, array![].span());
        i += 1;
    };
    
    dispatcher.submit_action(ActionType::Swap, "over limit", 0, 0, array![].span());
}
...
fn test_rate_limit_resets_next_day() {
    ...
    let mut i: u64 = 0;
    while i < 10 {
        dispatcher.submit_action(ActionType::MintNFT, "mint", 0, 0, array![].span());
        i += 1;
    };
    ...
    let new_action_id = dispatcher.submit_action(ActionType::Bridge, "bridge", 0, 0, array![].span());
...
fn test_execute_action_by_authorized_backend() {
    ...
    start_cheat_caller_address(dispatcher.contract_address, user);
    let action_id = dispatcher.submit_action(ActionType::MultiStep, "complex", 0, 0, array![].span());
...
fn test_execute_action_unauthorized_fails() {
    ...
    start_cheat_caller_address(dispatcher.contract_address, user);
    let action_id = dispatcher.submit_action(ActionType::Swap, "test", 0, 0, array![].span());
...
fn test_rotate_backend_signer_updates_executor_authority() {
    ...
    start_cheat_caller_address(dispatcher.contract_address, user);
    let action_id = dispatcher.submit_action(ActionType::Swap, "rotate backend", 0, 0, array![].span());
    stop_cheat_caller_address(dispatcher.contract_address);
...
fn test_rotate_backend_signer_revokes_old_signer() {
    ...
    start_cheat_caller_address(dispatcher.contract_address, user);
    let action_id = dispatcher.submit_action(ActionType::Swap, "old backend should fail", 0, 0, array![].span());
    stop_cheat_caller_address(dispatcher.contract_address);
...
fn test_max_actions_per_user_enforced() {
    ...
    start_cheat_caller_address(dispatcher.contract_address, user);
    dispatcher.submit_action(ActionType::Swap, "one", 0, 0, array![].span());
    dispatcher.submit_action(ActionType::Swap, "two", 0, 0, array![].span());
    dispatcher.submit_action(ActionType::Swap, "three", 0, 0, array![].span());
}
