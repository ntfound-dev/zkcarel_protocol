...
use super::honk_verifier_circuits::{
    is_on_curve_excluding_infinity_bn254, run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_18_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_18_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_18_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_18_circuit,
    run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_18_PUB_22_circuit,
};
...
mod UltraKeccakZKHonkVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_18_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_18_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_18_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_18_circuit,
        run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_18_PUB_22_circuit, vk,
    };
    ...
    impl IUltraKeccakZKHonkVerifier of super::IUltraKeccakZKHonkVerifier<ContractState> {
        fn verify_ultra_keccak_zk_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_18_PUB_22_circuit(
            ...
            } // log_n -1 = 17 points || Proof points 10-26
            for lib_comm in full_proof.proof.libra_commitments {
                _points.append((*lib_comm).into());
            } // 3 points || Proof points 27-29
            _points.append(full_proof.proof.kzg_quotient.into()); // Proof point 30
            ...
            let mut scalars: Span<u384> = array![
                ...
                transcript.shplonk_z.into(), scalar_58,
            ]
                .span();

            // Check input points are on curve.
            // Skip the first 28 points as they are from VK and keep the last 30 proof points
            for point in points.slice(28, 30) {
                assert(
            ...
            assert(msm_hint.len() == 59 * 12, 'wrong glv&fakeglv hint size');
