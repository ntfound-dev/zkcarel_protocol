...
// Minimal transfer interface for reward distribution.
// Used to transfer pre-funded rewards on claims.
#[starknet::interface]
pub trait ICarelToken<TContractState> {
    // Transfers CAREL to the provided recipient.
    fn transfer(ref self: TContractState, recipient: ContractAddress, amount: u256) -> bool;
    // Burns CAREL from the caller balance.
...
pub mod SnapshotDistributor {
    ...
    impl SnapshotDistributorImpl of super::ISnapshotDistributor<ContractState> {
        ...
        // Marks claimed before transfers and splits 5% tax between treasury and dev wallet.
        fn claim_reward(ref self: ContractState, epoch: u64, amount: u256, proof: Span<felt252>) {
            ...
            // Calculate claim fee: 1.25% treasury + 1.25% dev + 2.5% burn
            ...
            // Execute transfers via ICarelTokenDispatcher
