...
pub trait IReferralAdmin<TContractState> {
    ...
    // Sets minimum activity required for a referrer to be eligible.
...
pub mod ReferralSystem {
    ...
    pub impl ReferralSystemImpl of super::IReferralSystem<ContractState> {
        ...
        // Updates referee points for an epoch and accrues bonus based on total points,
        // minus any bonus already awarded for this referee+epoch.
        fn record_referee_points(ref self: ContractState, epoch: u64, referee: ContractAddress, points: u256) {
            ...
            let eligible_points = if updated >= min_activity { updated } else { 0_u256 };
