...
/// @title INostraPool
/// @notice Minimal interface for depositing and withdrawing liquidity via Nostra.
#[starknet::interface]
pub trait INostraPool<TContractState> {
    /// @notice Deposits tokens into a Nostra lending pool.
    ...
    /// @notice Withdraws tokens from a Nostra lending pool.
