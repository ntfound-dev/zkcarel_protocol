...
mod PrivateSwap {
    ...
    use crate::trading::swap::privacy_router::{IPrivacyRouterDispatcher, IPrivacyRouterDispatcherTrait};
    use crate::trading::swap::action_types::ACTION_PRIVATE_SWAP;
    ...
    struct Storage {
        ...
        commitments: Map<ContractAddress, Array<felt252>>,
        max_private_amount: u256,
        daily_private_limit: Map<ContractAddress, (u256, u64)>, // (amount, reset_time)
    ...
    fn execute_private_swap(params: PrivateSwapParams) -> u256 {
        ...
        // Mark nullifier as used before external verification to prevent re-entrancy reuse.
