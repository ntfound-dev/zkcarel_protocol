...
mod ZkCarelRouter {
    ...
    use crate::trading::swap::action_types::ACTION_SWAP;
    ...
    struct Storage {
        ...
        oracle_asset_ids: Map<ContractAddress, felt252>,
        oracle_decimals: Map<ContractAddress, u32>,
        approved_dexes: Map<ContractAddress, bool>,
        approved_bridges: Map<ContractAddress, bool>,
        route_cache: Map<felt252, Route>,
