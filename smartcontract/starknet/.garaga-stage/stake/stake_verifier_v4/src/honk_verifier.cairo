...
use super::honk_verifier_circuits::{
    is_on_curve_excluding_infinity_bn254, run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_23_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_23_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_23_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_23_circuit,
    run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_23_PUB_22_circuit,
};
...
mod UltraKeccakZKHonkVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_23_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_23_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_23_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_23_circuit,
        run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_23_PUB_22_circuit, vk,
    };
    ...
    impl IUltraKeccakZKHonkVerifier of super::IUltraKeccakZKHonkVerifier<ContractState> {
        fn verify_ultra_keccak_zk_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_23_PUB_22_circuit(
            ...
            } // log_n -1 = 22 points || Proof points 10-31
            for lib_comm in full_proof.proof.libra_commitments {
                _points.append((*lib_comm).into());
            } // 3 points || Proof points 32-34
            _points.append(full_proof.proof.kzg_quotient.into()); // Proof point 35
            ...
            let mut scalars: Span<u384> = array![
                ...
                scalar_51, scalar_52, scalar_53, scalar_54, scalar_55, scalar_56, scalar_57,
                scalar_58, scalar_59, scalar_60, scalar_61, scalar_62, transcript.shplonk_z.into(),
                scalar_63,
            ]
                .span();

            // Check input points are on curve.
            // Skip the first 28 points as they are from VK and keep the last 35 proof points
            for point in points.slice(28, 35) {
                assert(
            ...
            assert(msm_hint.len() == 64 * 12, 'wrong glv&fakeglv hint size');
