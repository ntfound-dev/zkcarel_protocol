...
# Hex values from smartcontract/src/legacy/privacy/action_types.cairo
...
wire_privacy_router STAKING_WBTC_ADDRESS
...
# LimitOrderBook no longer exposes set_privacy_router (normal-mode only).
